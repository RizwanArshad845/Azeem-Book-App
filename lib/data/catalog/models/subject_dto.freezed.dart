...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SubjectDto&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.boardClassId, boardClassId) || other.boardClassId == boardClassId));
}
...
@override
String toString() {
  return 'SubjectDto(id: $id, name: $name, boardClassId: $boardClassId)';
}
...
class _SubjectDto extends SubjectDto {
  const _SubjectDto({required this.id, required this.name, required this.boardClassId}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SubjectDto&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.boardClassId, boardClassId) || other.boardClassId == boardClassId));
}
