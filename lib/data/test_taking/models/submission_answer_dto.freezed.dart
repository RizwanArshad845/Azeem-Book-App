...
mixin _$SubmissionAnswerDto {
 ...
 String get questionId; QuestionType? get type; String? get questionText; String? get answerText; int? get selectedOptionIndex; int? get correctOptionIndex; String? get expectedAnswer; int? get marksAwarded; int? get possibleMarks; List<TokenJudgementDto>? get tokenJudgements; String? get justification; String? get solutionExplanation; bool get gradedByAi;
...
@useResult
$Res call({
 String questionId, QuestionType? type, String? questionText, String? answerText, int? selectedOptionIndex, int? correctOptionIndex, String? expectedAnswer, int? marksAwarded, int? possibleMarks, List<TokenJudgementDto>? tokenJudgements, String? justification, String? solutionExplanation, bool gradedByAi
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String questionId,  QuestionType? type,  String? questionText,  String? answerText,  int? selectedOptionIndex,  int? correctOptionIndex,  String? expectedAnswer,  int? marksAwarded,  int? possibleMarks,  List<TokenJudgementDto>? tokenJudgements,  String? justification,  String? solutionExplanation,  bool gradedByAi)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SubmissionAnswerDto() when $default != null:
...
class _SubmissionAnswerDto extends SubmissionAnswerDto {
  const _SubmissionAnswerDto({required this.questionId, this.type, this.questionText, this.answerText, this.selectedOptionIndex, this.correctOptionIndex, this.expectedAnswer, this.marksAwarded, this.possibleMarks, this.tokenJudgements, this.justification, this.solutionExplanation, this.gradedByAi = false}): super._();
