...
///
/// - [loadingGate]: purchase-gate check + start-attempt call in flight.
...
/// - [submitting]: raw answers are being POSTed.
/// - [awaitingGrading]: submitted — polling for the server's AI-graded
///   result.
...
abstract class TestTakingState with _$TestTakingState {
  ...
  const factory TestTakingState({
    ...
    Test? test,
    String? attemptId,
    @Default(<AttemptQuestion>[]) List<AttemptQuestion> questions,
