...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Chapter&&(identical(other.chapter, chapter) || other.chapter == chapter)&&(identical(other.title, title) || other.title == title)&&(identical(other.mcqCount, mcqCount) || other.mcqCount == mcqCount)&&(identical(other.shortCount, shortCount) || other.shortCount == shortCount));
}
...
@override
String toString() {
  return 'Chapter(chapter: $chapter, title: $title, mcqCount: $mcqCount, shortCount: $shortCount)';
}
...
class _Chapter implements Chapter {
  const _Chapter({required this.chapter, required this.title, required this.mcqCount, required this.shortCount});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Chapter&&(identical(other.chapter, chapter) || other.chapter == chapter)&&(identical(other.title, title) || other.title == title)&&(identical(other.mcqCount, mcqCount) || other.mcqCount == mcqCount)&&(identical(other.shortCount, shortCount) || other.shortCount == shortCount));
}
