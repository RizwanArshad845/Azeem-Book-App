...
@useResult
$Res call({
 String id, String studentId, String testId, TestAttemptStatus status, List<SubmissionAnswer> answers, double? scorePercent, int? totalMarksAwarded, int? totalPossibleMarks, List<String>? weakChapterIds, List<String>? strongChapterIds, int? durationSeconds, bool isLiveTestAttempt, DateTime attemptedAt, DateTime? submittedAt
});
...
/// Create a copy of TestAttempt
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? studentId = null,Object? testId = null,Object? status = null,Object? answers = null,Object? scorePercent = freezed,Object? totalMarksAwarded = freezed,Object? totalPossibleMarks = freezed,Object? weakChapterIds = freezed,Object? strongChapterIds = freezed,Object? durationSeconds = freezed,Object? isLiveTestAttempt = null,Object? attemptedAt = null,Object? submittedAt = freezed,}) {
...
as List<SubmissionAnswer>,scorePercent: freezed == scorePercent ? _self.scorePercent : scorePercent // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String studentId,  String testId,  TestAttemptStatus status,  List<SubmissionAnswer> answers,  double? scorePercent,  int? totalMarksAwarded,  int? totalPossibleMarks,  List<String>? weakChapterIds,  List<String>? strongChapterIds,  int? durationSeconds,  bool isLiveTestAttempt,  DateTime attemptedAt,  DateTime? submittedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TestAttempt() when $default != null:
...
class _TestAttempt implements TestAttempt {
  const _TestAttempt({required this.id, required this.studentId, required this.testId, required this.status, this.answers = const <SubmissionAnswer>[], this.scorePercent, this.totalMarksAwarded, this.totalPossibleMarks, this.weakChapterIds, this.strongChapterIds, this.durationSeconds, this.isLiveTestAttempt = false, required this.attemptedAt, this.submittedAt});
