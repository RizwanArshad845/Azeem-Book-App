...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CartItem&&(identical(other.testId, testId) || other.testId == testId)&&(identical(other.price, price) || other.price == price)&&(identical(other.discountedPrice, discountedPrice) || other.discountedPrice == discountedPrice));
}
...
@override
String toString() {
  return 'CartItem(testId: $testId, price: $price, discountedPrice: $discountedPrice)';
}
...
class _CartItem implements CartItem {
  const _CartItem({required this.testId, required this.price, this.discountedPrice});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CartItem&&(identical(other.testId, testId) || other.testId == testId)&&(identical(other.price, price) || other.price == price)&&(identical(other.discountedPrice, discountedPrice) || other.discountedPrice == discountedPrice));
}
